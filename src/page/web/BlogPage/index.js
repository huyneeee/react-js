    ...
    return (
        ...
        <div className="flex px-32 mt-10">
            ...
            <div className="flex flex-col w-3/4">
                ...
                {listBlog.map(blog => {
                    return (
                        <div className="h-70 flex border-b border-gray-400 py-8" key={blog.id}>
                            <div className="w-2/5 ">
                            ...
                            <div className="w-3/5 pl-8 relative">
                                ...
                                <Link to={`/blog/${blog.id}`} className="px-5 py-2 bg-black text-white rounded-full font-semibold text-sm absolute bottom-5 ">Read More</Link>
                            </div>
                        </div>
                    )
                })}
